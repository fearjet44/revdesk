...
Behavior lock. Do not tell the coding agent to use `git stash`. Save WIP however the tree already works (`control/working/…`). Kind moves from create-time to review-time in Slice 5 — see `docs/plan/slice-5-deferred-kind.md`.
